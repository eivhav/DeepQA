...
# Based on code from https://github.com/codekansas/keras-language-modeling
...
path = '/home/havikbot/PycharmProjects/data/watson_insurance/'
...
parser.add_argument('--iter', metavar='N', type=int, default=50, help='number of times to run')
...
model = Word2Vec(sentences, size=args.size, min_count=3, window=8, sg=1, iter=args.iter)
weights = model.syn0
...
np.save(open(data_path+'word2vec_%d_dim_w8_mc3_skip_ins' % args.size, 'wb'), emb)
